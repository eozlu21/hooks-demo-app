...
function ChildComponent() {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', textAlign: 'center' , border: '2px solid black', padding: '10px' }}>
            <h1>Beginning of ChildComponent</h1>
            <p>Context Value Displayed in ChildComponent: {value}</p>
            <Button onClick={handleChange}>Change Context Value in ChildComponent</Button>
